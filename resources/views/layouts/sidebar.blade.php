  ...
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
        <li class="nav-item">
            ...
            <span class="mt-1 ms-1 sidebar-text">PPAT Overview</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <span class="nav-link  collapsed  d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-app">
                <span>
                    ...
                    <span class="sidebar-text">Component</span>
                </span>
                ...
                <ul class="flex-column nav">
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ url('/form') }}">
                            <span class="sidebar-text">Form Page</span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ url('/table') }}">
                            <span class="sidebar-text">Tables Page</span>
                        </a>
                    </li>
                </ul>
            </div>
